        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-xl-8">
                    ...
                    <div class="post-img">
                        <button class="play-btn v1 venobox vbox-item" data-vbtype="video" data-maxwidth="800px" data-autoplay="true" data-href="https://youtu.be/OzGudoy7keA?start=79"> <span class="my-icon icon-play-t"></span></button>
